...
class FormatDetectionTest extends TestCase
{
    ...
    #[Test] public function it_detects_webp_format_for_webp_conversion()
    {
        // Arrange
    ...
    #[Test] public function it_detects_avif_format_for_avif_conversion()
    {
        // Arrange
    ...
    #[Test] public function it_detects_png_format_for_png_conversion()
    {
        // Arrange
    ...
    #[Test] public function it_keeps_original_format_when_no_format_change()
    {
        // Arrange
    ...
    #[Test] public function it_returns_original_url_when_no_conversion_specified()
    {
        // Arrange
    ...
    #[Test] public function it_falls_back_to_original_extension_on_detection_failure()
    {
        // Arrange
        $file = UploadedFile::fake()->image('test.jpg', 200, 200);
        $media = MediaUploader::source($file)->upload();
    ...
    #[Test] public function has_conversion_method_works_correctly()
    {
        // Arrange
        $file = UploadedFile::fake()->image('test.jpg', 200, 200);
        $media = MediaUploader::source($file)->upload();
    ...
    #[Test] public function extension_mapping_works_for_all_supported_formats()
    {
        $file = UploadedFile::fake()->image('test.jpg', 200, 200);
        $media = MediaUploader::source($file)->upload();
